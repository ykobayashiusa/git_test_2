...
constexpr point  operator*( const point &lhs, const tensor &rhs ) noexcept;
...
constexpr
point operator*( const point &lhs, const tensor &rhs ) noexcept
{
    return point
    {
        rhs.data[0][0]*lhs.x + rhs.data[1][0]*lhs.y + rhs.data[2][0]*lhs.z,
        rhs.data[0][1]*lhs.x + rhs.data[1][1]*lhs.y + rhs.data[2][1]*lhs.z,
        rhs.data[0][2]*lhs.x + rhs.data[1][2]*lhs.y + rhs.data[2][2]*lhs.z
    };
}
